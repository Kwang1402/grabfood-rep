package com.app.java.grabfoodappproject.ui.fragment.crowd_pick;
...
import com.app.java.grabfoodappproject.data.model.crowd_pick.FoodSale;

import java.util.ArrayList;
import java.util.List;

public class CrowdPickAdapter extends RecyclerView.Adapter<CrowdPickAdapter.ViewHolder>{
    private final List<FoodSale> mFood4List;

    public CrowdPickAdapter(List<FoodSale> food4List) {
        if(food4List == null){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.cp_item_food,parent,false
        );
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(FoodSale food4){
